...
const ServicesPage = () => {
  ...
  return (
    <main>
      ...
      <section className="flex justify-around max-[750px]:flex-wrap max-[650px]:text-[100px] max-[400px]:px-[0px] px-[60px] my-[20px] !important">
        <div className="px-[30px] leading-[40px]">
        ...
        <form action="post" className="w-[100%] px-[30px] my-[10px] shadow-sm shadow-gray-100">
          <div className="w-full flex justify-center gap-[10px]">
            <input type="text" placeholder="Name" className="rounded-full w-full mx-[3px] my-[10px] px-[15px] py-[7px] outline-none shadow shadow-gray-300" />
            <input type="email" placeholder="Email" className="rounded-full w-full mx-[3px] my-[10px] px-[15px] py-[7px] outline-none shadow shadow-gray-300" />
          </div>
          <input type="text" placeholder="Subject" className="rounded-full my-[10px] px-[15px] py-[7px] outline-none shadow shadow-gray-300 w-full" />
          <div>
            <input name="" id="" placeholder="Message" className="rounded-full my-[10px] px-[15px] py-[7px] outline-none shadow shadow-gray-300 w-full"></input>
          </div>
